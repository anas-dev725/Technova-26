        ...
        {[...Array(6)].map((_, i) => (
          <div key={i} className="flex items-center gap-12 px-8">
            ...
            <p className="text-[11px] sm:text-sm font-black text-white uppercase tracking-tighter">
              USE PROMO CODE <span className="bg-white/20 px-2 py-0.5 rounded font-mono text-white border border-white/30">TECHNOVA30</span> TO AVAIL EARLY BIRD DISCOUNT — 30% OFF ENDS ON 10th JUNE
            </p>
          </div>
        ))}
      </div>
