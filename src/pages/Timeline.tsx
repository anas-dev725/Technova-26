  ...
  const timelineData: Record<'day1' | 'day2', TimelineEvent[]> = {
    day1: [
      { 
        ...
        track: "General", 
        location: "IT Main Building Desk", 
        icon: Users,
      ...
      { 
        ...
        duration: 4.5,
        title: "FYP Warriors", 
        desc: "Pitch your capstone design projects and software prototypes in front of top local engineering recruiters and incubators.", 
        track: "Innovation", 
        location: "SSK Wing B & C", 
        icon: Award,
      ...
      { 
        ...
        duration: 2.0,
        title: "AI Symposium", 
        desc: "Inspirational keynotes and panel discussions on state-of-the-art AI trends, machine learning, and emerging technology.", 
        track: "AI", 
        location: "CBM Auditorium", 
        icon: Sparkles,
      ...
      { 
        ...
        track: "General", 
        location: "Dining Area / Food Court", 
        icon: CoffeeIcon,
        durationLabel: "1 Hour"
      },
      { 
        ...
        desc: "Celebrate victorious achievements, distribute awards & participation certificates, and record closing moments.", 
        track: "General", 
        location: "CBM Auditorium", 
        icon: Trophy,
        capacity: "All Attendees",
              ...
              <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-blue-500/[0.2] relative">
                <div className="min-w-[1050px] p-6 lg:p-8 relative">
                  ...
                  <div className="space-y-4 pt-1 pb-4 relative z-20 min-h-[400px]">
                    {filteredEvents.length === 0 ? (
                      ...
                      filteredEvents.map((event, idx) => {
                        ...
                        // Linear math conversion to percentage offsets spanning 9 hour duration (from 8:00 AM to 5:00 PM)
                        const startPct = ((event.startHour - 8.0) / 9.0) * 100;
                  ...
                  <div className="mt-6 border-t border-gray-200 dark:border-white/5 pt-4 flex items-center justify-between text-xs text-gray-450 dark:text-gray-400 font-bold">
                    <span>8:30 AM — 5:00 PM Schedule Horizon</span>
