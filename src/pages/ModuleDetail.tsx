...
import { modules, getFees, isDiscountEligible, TeamMode, getCertificateDriveLink } from '../data/modules';
          ...
          <div className="lg:col-span-8">
            ...
            >
              <div className="relative z-10">
                ...
                {/* E-Certificates Drive Section */}
                {module.id !== 'maths-mania' && module.id !== 'maths-mania-advanced' && (
                  <div className="mb-8 bg-gradient-to-br from-amber-500/5 via-gray-50 to-amber-500/10 dark:from-amber-500/10 dark:via-[#0c0c0c] dark:to-amber-500/5 rounded-[2rem] border border-amber-500/20 dark:border-amber-500/20 p-6 sm:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden shadow-sm">
                    ...
                    <div className="flex-1 space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h4 className="text-lg font-black text-gray-900 dark:text-white uppercase tracking-wider flex items-center gap-2">
                            E-Certificates
                          </h4>
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed max-w-xl">
                        Access and download your e-certificates directly from the dedicated folder for this module. Find your certificate file named after your participant name.
                      </p>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-3 shrink-0 w-full md:w-auto">
                      <a
                        href={getCertificateDriveLink(module)}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="h-12 px-6 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all active:scale-[0.98] shadow-md shadow-amber-500/20 w-full sm:w-auto"
                      >
