...
export const getCertificateDriveLink = (module: Module | string): string => {
  ...
  const defaultLinks: Record<string, string> = {
    ...
    'datathon': 'https://drive.google.com/drive/folders/19vCNVvz5bFP95cmj-2HajV9snxT8-vad',
...
export const modules: Module[] = [
  ...
  },
  {
    ...
    prize: 'Upto 70K PKR',
    isFilled: true,
    certificateDriveLink: 'https://drive.google.com/drive/folders/13YQWy4kcIQGZ0_mmjuafB9DbCEUWcRxE',
  ...
  },
  {
    ...
    prize: 'TBD',
    isFilled: true,
    certificateDriveLink: 'https://drive.google.com/drive/folders/19vCNVvz5bFP95cmj-2HajV9snxT8-vad',
